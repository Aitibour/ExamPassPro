...
const SECTIONS = [
  ...
  },
  {
    ...
    color: '#7B42BC',
    filter: (s: string) => s.startsWith('hashicorp-') || s.startsWith('jenkins-') || s.startsWith('terraform-'),
  },
  {
    id: 8,
    name: 'Databases',
    ...
    color: '#13aa52',
    filter: (s: string) => s.startsWith('mongodb-') || s.startsWith('oracle-') || s.startsWith('sqlserver-'),
  },
  {
    id: 9,
    ...
    slug: 'cissp',
    color: '#e74c3c',
    filter: (s: string) => s.startsWith('cissp-') || s.startsWith('ceh-'),
  },
  {
    id: 10,
    ...
    filter: (s: string) =>
      ![
        'aws-', 'azure-', 'microsoft-', 'google-', 'cisco-', 'comptia-',
        'kubernetes-', 'docker-', 'hashicorp-', 'jenkins-', 'terraform-',
        'mongodb-', 'oracle-', 'sqlserver-', 'cissp-', 'ceh-',
