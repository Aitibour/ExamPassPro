...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://exampasspro.co/comparisons/aws-vs-azure-vs-gcp',
    type: 'article',
...
export default function Page() {
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-gradient-to-r from-purple-600 to-indigo-800 min-h-[300px] flex items-center justify-center px-6 py-16 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img
            src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1920&h=1280&fit=crop"
            alt="Cloud data center and server infrastructure"
