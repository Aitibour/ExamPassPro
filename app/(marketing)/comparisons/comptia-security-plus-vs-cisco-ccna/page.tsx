...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://exampasspro.co/comparisons/comptia-security-plus-vs-cisco-ccna',
    type: 'article',
...
export default function Page() {
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-gradient-to-r from-red-600 to-pink-700 min-h-[300px] flex items-center justify-center px-6 py-16 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img
            src="https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=1920&h=1280&fit=crop"
            alt="Cybersecurity monitoring and security systems"
