...
export default function Page() {
  return (
    <div className="bg-slate-50 min-h-screen">
      {/* Hero with Image */}
      <section className="bg-gradient-to-r from-amber-500 to-yellow-600 py-16 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex gap-4">
                <Link href="/courses" className="inline-flex px-6 py-2 bg-white text-amber-600 font-semibold rounded-lg hover:bg-amber-50 transition-colors">
                  Start Study Plan
                </Link>
              </div>
            </div>
