...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://exampasspro.co/roadmaps/google-cloud-path',
    type: 'article',
...
export default function Page() {
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-gradient-to-r from-yellow-500 to-red-500 min-h-[300px] flex items-center justify-center px-6 py-16 overflow-hidden">
