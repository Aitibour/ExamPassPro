...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://exampasspro.co/roadmaps/comptia-security-path',
    type: 'article',
...
export default function Page() {
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-gradient-to-r from-red-600 to-purple-700 min-h-[300px] flex items-center justify-center px-6 py-16 overflow-hidden">
