...
const PLANS: Record<string, {
  ...
  starter: {
    label: 'Starter',
    tagline: 'Get started with certification prep',
  ...
  pro: {
    label: 'Pro',
    tagline: 'Accelerate your exam success',
  ...
  platinum: {
    label: 'Platinum',
    tagline: 'Full coaching & priority support',
    ...
    community: 'private',
    coaching: '30-min',
    supportLevel: 'Level 2 + Priority',
    lifetime: false,
    upgradeTo: 'all_access',
  },
  all_access: {
    label: 'All-Access',
    tagline: 'Unlimited access · Lifetime',
    badgeCls: 'bg-amber-100 text-amber-700 border border-amber-200',
    ringCls: 'border-amber-200',
    mockExams: 10,
    aiChat: true,
    aiChatLabel: 'Unlimited AI Chat forever',
    community: 'private',
    coaching: '60-min',
    supportLevel: 'Level 3 + Priority',
    lifetime: true,
    upgradeTo: null,
  },
}
...
const UPGRADE_LABELS: Record<string, string> = {
  pro: 'Upgrade to Pro',
  platinum: 'Upgrade to Platinum',
  all_access: 'Upgrade to All-Access',
}
