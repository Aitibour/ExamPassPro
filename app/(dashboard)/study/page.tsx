  ...
  return (
    <div>
      <div className="mb-7">
        ...
        <p className="text-slate-500 text-sm mt-1">Select a course to study with instant feedback</p>
      </div>
      ...
      {purchases && purchases.length > 0 ? (
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-12 text-center">
          ...
          <p className="text-slate-400 text-sm mb-6">Purchase a course to access study mode.</p>
          <Link
            href="/courses"
